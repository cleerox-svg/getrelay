...
- **Headless harness** (vitest). `pnpm --filter @relay/ui test` drives the REAL
  ...
  Current golf + `scene3d` coverage: **663 tests across 22 files** —
  ...
  `golf/pendingScore` 8, `golf/scene/quality` 8, `golf/ChallengeCard` 6,
  `scene3d/budget` 5, `components/golf/budget` 4, `golf/GolfScreen.score` 4,
  `scene3d/stats` 4, `env.irradiance` 4, `golf/GolfGame.abandon` 2.
