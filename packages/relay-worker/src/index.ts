...
import { gifsRoutes } from './gifs';
import { itunesRoutes } from './itunes';
import { tunesRoutes } from './tunes';
...
app.route('/', gifsRoutes());
app.route('/', itunesRoutes());
app.route('/', tunesRoutes());
