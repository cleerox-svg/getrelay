...
// Weekly / all-time Fog leaderboard. Rows come pre-ranked from the
// worker; the caller's own row arrives flagged `mine`.
export function FogLeaderboard({ refreshKey = 0 }: Props) {
